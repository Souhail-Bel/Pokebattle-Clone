...
public class Battle {
  ...
  public void setPlayer1PokemonId(Long player1PokemonId) {
    this.player1PokemonId = player1PokemonId;
  }

  public Long getPlayer2PokemonId() { return player2PokemonId; }
  public void setPlayer2PokemonId(Long player2PokemonId) {
    this.player2PokemonId = player2PokemonId;
  }

  public int getPlayer1CurrentHp() { return player1CurrentHp; }
  public void setPlayer1CurrentHp(int player1CurrentHp) {
    this.player1CurrentHp = player1CurrentHp;
  }

  public int getPlayer2CurrentHp() { return player2CurrentHp; }
  public void setPlayer2CurrentHp(int player2CurrentHp) {
    this.player2CurrentHp = player2CurrentHp;
  }
